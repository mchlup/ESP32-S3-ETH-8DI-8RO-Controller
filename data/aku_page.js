  ...
  function renderSrcPicker(idPrefix, srcObj){
    ...
    return `
      <div class="kv" style="grid-template-columns: 210px 1fr;">
        ...
        <div class="v"><input id="${id('maxAgeMs')}" type="number" min="0" max="3600000" step="1000" style="width:140px" /> ms</div>
      ...
      <div class="grid12">
        ...
        <div class="card col6">
          ...
          <div class="btnRow" style="display:flex;gap:8px;flex-wrap:wrap">
            <button class="btn" id="aku_btn_load">Načíst z /config.json</button>
            <button class="btn primary" id="aku_btn_save">Uložit</button>
            <button class="btn" id="aku_btn_goThermom">Otevřít Teploměry</button>
          </div>
          <div class="hr"></div>
        ...
        <div class="card col6">
          ...
          <div class="kv" style="grid-template-columns: 240px 1fr;">
            ...
            <div class="v">
              <select id="eq_akuNoSupportBehavior" class="sel" style="width:220px">
                <option value="close">Zavřít ventil (0%)</option>
                <option value="hold">Držet polohu</option>
              </select>
            </div>

            <div class="k">Min. TOP – den</div><div class="v"><input id="eq_akuMinTopC_day" type="number" min="0" max="90" step="0.5" style="width:140px" /> °C</div>
            <div class="k">Min. TOP – noc</div><div class="v"><input id="eq_akuMinTopC_night" type="number" min="0" max="90" step="0.5" style="width:140px" /> °C</div>

            <div class="k">Min. Δ k cíli – den</div><div class="v"><input id="eq_akuMinDeltaToTargetC_day" type="number" min="0" max="40" step="0.5" style="width:140px" /> °C</div>
            <div class="k">Min. Δ k cíli – noc</div><div class="v"><input id="eq_akuMinDeltaToTargetC_night" type="number" min="0" max="40" step="0.5" style="width:140px" /> °C</div>

            <div class="k">Min. Δ ke kotli – den</div><div class="v"><input id="eq_akuMinDeltaToBoilerInC_day" type="number" min="0" max="40" step="0.5" style="width:140px" /> °C</div>
            <div class="k">Min. Δ ke kotli – noc</div><div class="v"><input id="eq_akuMinDeltaToBoilerInC_night" type="number" min="0" max="40" step="0.5" style="width:140px" /> °C</div>
          </div>
          ...
          <div class="grid12" style="align-items:start">
            ...
            <div class="col6">
              <div class="kv" style="grid-template-columns: 240px 1fr;">
                ...
                <div class="v"><input id="h_targetTopC" type="number" min="0" max="95" step="0.5" style="width:140px" /> °C</div>

                <div class="k">Hystereze (hysteresisC)</div>
                <div class="v"><input id="h_hysteresisC" type="number" min="0" max="20" step="0.1" style="width:140px" /> °C</div>

                <div class="k">Max. doba zapnutí</div>
                <div class="v"><input id="h_maxOnMin" type="number" min="0" max="1440" step="1" style="width:140px" /> min</div>

                <div class="k">Min. doba vypnutí</div>
                <div class="v"><input id="h_minOffMin" type="number" min="0" max="1440" step="1" style="width:140px" /> min</div>
              </div>
