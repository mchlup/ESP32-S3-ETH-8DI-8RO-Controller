...
(function(){
  ...
  function render(){
    ...
    hostEl.innerHTML = `
      <div class="pageHead">
        <div class="pageTitle">Cirkulace TUV</div>
          ...
          <div class="card__body">
            ...
            <div class="grid2">
              ...
              <div>
                ...
                <div class="row" style="gap:8px">
                  <input class="inp w140" id="rc_stopTemp" type="number" step="0.1" min="0" max="80">
            ...
            <div class="grid2">
              <div>
                ...
                <div class="row" style="gap:8px">
                  <input class="inp w140" id="rc_onDemandMin" type="number" step="0.5" min="0" max="240">
              ...
              <div>
                ...
                <div class="row" style="gap:8px; flex-wrap:wrap">
                  <div class="row" style="gap:6px; align-items:center">
                    <input class="inp w120" id="rc_minOffMin" type="number" step="1" min="0" max="1440">
                    <div class="muted">min OFF</div>
                  </div>
                  <div class="row" style="gap:6px; align-items:center">
                    <input class="inp w120" id="rc_minOnSec" type="number" step="1" min="0" max="3600">
            ...
            <div class="grid2">
              ...
              <div>
                ...
                <div class="row" style="gap:8px; flex-wrap:wrap">
                  <div class="row" style="gap:6px; align-items:center">
                    <input class="inp w120" id="rc_cycleOnMin" type="number" step="1" min="0" max="240">
                    <div class="muted">min ON</div>
                  </div>
                  <div class="row" style="gap:6px; align-items:center">
                    <input class="inp w120" id="rc_cycleOffMin" type="number" step="1" min="0" max="240">
                    <div class="muted">min OFF</div>
                  </div>
                </div>
...
<option value="opentherm_solar_collector">OpenTherm: solar collector</option>
                ...
                <div>
                  ...
                  <div class="row" style="gap:8px; flex-wrap:wrap">
                    <input class="inp w160" id="rc_bleId" placeholder="BLE id">
                  ...
                  <div class="row" style="gap:8px; flex-wrap:wrap; margin-top:8px">
                    <input class="inp w220" id="rc_mqttTopic" placeholder="MQTT topic">
                    <input class="inp w140" id="rc_mqttKey" placeholder="JSON key">
                  </div>
                </div>
              </div>
            </div>
      ...
      return `
        <div class="card" style="padding:12px; margin:0 0 10px 0">
          ...
          <div class="row" style="gap:10px; flex-wrap:wrap; margin-top:8px">
            <label class="lbl" style="margin:0">Start <input class="inp w140" type="time" step="60" data-k="start" value="${esc(start)}" data-i="${idx}" style="margin-left:6px"></label>
            <label class="lbl" style="margin:0">Konec <input class="inp w140" type="time" step="60" data-k="end" value="${esc(end)}" data-i="${idx}" style="margin-left:6px"></label>
          </div>
        </div>
      `;
